...
var db = wx.cloud.database();var _default =
{
  ...
  (0, _vuex.mapMutations)(['setAudiolist', 'setPlaydetail', 'setIsplayingmusic', 'setIsplayactive'])), {}, {
    ...
    //下一首播放
    next: function next(isAuto, isCon) {
